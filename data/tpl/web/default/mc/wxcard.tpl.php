...
<form action="" class="form-horizontal form" method="post" enctype="multipart/form-data" id="form1">
		...
		<div class="panel panel-default" id="cardmain">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">跳转激活链接<span style="color:red">*</span></label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="wx_activate_after_submit_url" value="" class="form-control">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">电话<span style="color:red">*</span></label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="service_phone" value="" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">会员卡特权说明<span style="color:red">*</span></label>
					<div class="col-sm-9 col-xs-12">
						<textarea name="prerogative" value="" class="form-control"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">使用须知<span style="color:red">*</span></label>
					<div class="col-sm-9 col-xs-12">
