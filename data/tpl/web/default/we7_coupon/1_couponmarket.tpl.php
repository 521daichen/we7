						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<table class="table">
									...
									<tr>
										<td><input type="radio" name="coupons" id="coupon" class="coupon check" value="<?php  echo $coupon['id'];?>" <?php  if(is_array($item['coupons']) && in_array($coupon['id'], array_keys($item['coupons']))) { ?>checked<?php  } ?> data-title="<?php  echo $coupon['title'];?>" data-type="<?php  echo $coupon['type'];?>"></td>
