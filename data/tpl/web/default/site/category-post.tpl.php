...
<ol class="breadcrumb we7-breadcrumb">
	...
	<li>
		<?php  if(empty($id)) { ?><a href="<?php  echo url('site/category/post')?>">分类添加</a><?php  } ?>
		<?php  if(!empty($id)) { ?><a href="<?php  echo url('site/category/post', array('id' => $id))?>">分类编辑</a><?php  } ?>
	</li>
</ol>
	...
	<div class="we7-form" id="js-wesite-category-post" ng-controller="WesiteCategoryPost" ng-cloak>
		<div class="form-group" ng-if="category.name">
			...
			<div class="form-controls col-sm-8">
				<div class="form-control-static"><a href="<?php  echo $_W['siteroot'];?>/app/index.php?c=site&a=site&cid=<?php  echo $category['id'];?>&i=<?php  echo $_W['uniacid'];?>" target="_blank">/app/index.php?c=site&a=site&cid={{category.id}}&i=<?php  echo $_W['uniacid'];?></a></div>
		...
		<div class="form-group">
			...
			<div class="form-controls col-sm-8">
				...
				<div class="we7-input-img input-more active">
					<img src="<?php  echo $_W['siteroot'];?>app/themes/{{category.style.tname}}/preview.jpg" id="current-preview" class="img-rounded">
						...
						<div class="item item-style" ng-class="{'active': style.id == category.styleid}" ng-repeat="style in styles" ng-style="{'width': '20%', 'height': '290px', 'padding': '10px 10px', 'float': 'left'}">
							<div class="title">
								...
								<a href="javascript:;" ng-click="changeStyle(style.id)">
									<img src="../app/themes/{{style.tname}}/preview.jpg" class="img-rounded preview-{{style.id}}" ng-style="{'height': '225px'}">
								</a>
							</div>
					...
					<div class="form-group" ng-if="category.icontype != 2">
						...
						<div class="form-controls col-sm-8" >
							<div class="input-group">
								...
								<span class="input-group-addon" style="width:35px; border-left:none" ng-style="{'background-color' : colorValue}"><i class="{{category.css.icon.icon}}" ng-init="category.css.icon.icon = 'fa fa-external-link'"></i></span>
